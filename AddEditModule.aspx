...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DropDownList class="form-control" ID="DropDownListMain" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Management_Choice"></asp:DropDownList>
    ...
    <!-- Add Module -->
        ...
        UpdateCommand="UPDATE [Module] SET [moduleCode] = @moduleCode, [moduleTitle] = @moduleTitle WHERE [moduleID] = @moduleID">
            ...
            <InsertParameters>
                <asp:Parameter Name="module Code" Type="String" />
